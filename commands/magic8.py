...
magic8_list = ["Zu 100% Ja!", "Es ist so entschieden, Ja.","Ja :3 OwO", "Ohne Zweifel, Ja.", "Definitiv, Ja.", "Kannst dich drauf verlassen, Digga.", "So wie ich des seh, scho, Ja.", "Denk scho, Ja.", "Ja.", "Ich hab Dieter um rat gefragt, er sagt Ja.",
                 ...
                 "Dieter hat Nein gesagt :///", "Ich weiß nicht, aber wie wärs mit Megges?", "Nein, du HUNDT.", "Geht dich nen scheißdreck an, Mois.", "H̶͕̦̬̮̖̼̠͈̗͈̤̥̣̣̋̂̐̆̈́̊͋́͠͝i̵̢̥̻̹͉̰̟̤͔̰̾͛ͅn̴̹͈̬̝̦͇̤͍͒̅ͅť̷̨̙̣̘̗͙̞͔̳͗̆͂̑e̸̢̫̝̭̗̰̙̲̟̼̝̺͇̥͜͝r̷̛̭̣͔͚̳͑̿̈́̄͋̂̊̾͗̉̾̿͜͝͝ ̸̨̬̖̦͉͍̯̜͕͔̪̭̜͚̒d̷̟̼̯̺͔̯̱̞̊̐̆̽̑̎̚͜ĭ̵̡͙̓̏͗̈̒͐͋̐̄͝ͅr̶̭̱̫͍͙͙̻̩͓̱̍̿̾́̓̈̆̔͂̂͒̏̽͝.", "Nur wenn KOSCHDELOS is."]
