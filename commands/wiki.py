    ...
    async def wiki(self, ctx, *search_term):
        try:
            ...
            for bild in image_tag:
                ...
                if (
                    bild_url
                    == "https://upload.wikimedia.org/wikipedia/commons/thumb/e/ea/Disambig-dark.svg/25px"
                    "-Disambig-dark.svg.png"
                    or bild_url == "https://upload.wikimedia.org/wikipedia/c"
                    "ommons/thumb/f/f3/Photo-request.svg/40px-P"
                    "hoto-request.svg.png"
                    or bild_url
                    == "https://upload.wikimedia.org/wikipedia/commons/thumb/4/43/Qsicon_lesenswert."
                    "svg/15px-Qsicon_lesenswert.svg.png"
                    or bild_url == "https://upload.wikimedia."
